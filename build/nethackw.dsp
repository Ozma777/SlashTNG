...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib comctl32.lib advapi32.lib winmm.lib /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/SlashTNGw.exe" /pdbtype:sept
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comctl32.lib advapi32.lib winmm.lib libgtk-win32-2.0.dll.a libgdk-win32-2.0.dll.a libglib-2.0.dll.a libgdk_pixbuf-2.0.dll.a libgobject-2.0.dll.a libpango-1.0.dll.a /nologo /subsystem:windows /debug /machine:I386 /out:"Debug/SlashTNGw.exe" /pdbtype:sept
# Begin Special Build Tool
OutDir=.\NetHackW___Win32_GTK_Debug
SOURCE="$(InputPath)"
PostBuild_Desc=Install exe
PostBuild_Cmds=if NOT exist ..\binary\*.* mkdir ..\binary	  copy $(OutDir)\Debug\SlashTNGw.exe ..\binary	  copy ..\dat\nhshare ..\binary	  copy ..\dat\nhushare ..\binary	  copy ..\dat\license ..\binary	 rem  if exist ..\src\tiles.bmp copy ..\src\tiles.bmp ..\binary	  if exist ..\src\tiles32.bmp copy ..\src\tiles32.bmp ..\binary	  if exist ..\doc\Guidebook.txt copy ..\doc\Guidebook.txt ..\binary\Guidebook.txt	  if exist ..\doc\slashem.txt copy ..\doc\slashem.txt ..\binary\SlashEM.txt	  copy ..\sys\winnt\defaults.nh ..\binary\defaults.nh
# End Special Build Tool
...
# ADD BSC32 /nologo
LINK32=link.exe
# ADD BASE LINK32 kernel32.lib user32.lib gdi32.lib comctl32.lib advapi32.lib winmm.lib /nologo /subsystem:windows /map /debug /machine:I386 /out:"Release/SlashTNGw.exe" /MAPINFO:EXPORTS /MAPINFO:LINES
# SUBTRACT BASE LINK32 /pdb:none
# ADD LINK32 kernel32.lib user32.lib gdi32.lib comctl32.lib advapi32.lib winmm.lib libgtk-win32-2.0.dll.a libgdk-win32-2.0.dll.a libglib-2.0.dll.a libgdk_pixbuf-2.0.dll.a libgobject-2.0.dll.a libpango-1.0.dll.a /nologo /subsystem:windows /map /debug /machine:I386 /out:"Release/SlashTNGw.exe" /MAPINFO:EXPORTS /MAPINFO:LINES
# SUBTRACT LINK32 /pdb:none
# Begin Special Build Tool
